...
function Main() {
  return (
    <>
     <div className="bg-[#0d111a] text-white lg:flex-row lg:h-[620px] h-[1100px] flex lg:space-x-96 flex-col items-center justify-center space-y-10">
        <div className="flex flex-col justify-center items-center space-y-5 ">
          <h1 className=" text-[30px] font-bold lg:text-[40px]">Tackle, Talent Scouting</h1>
          <div className='text-[16px] mx-5 lg:text-[18px] lg:max-w-[500px] '>
      ...
      <div className="bg-[#131b2a] text-white lg:flex-row h-[1100px] flex-col flex lg:space-x-32   lg:h-[600px] space-y-10 items-center justify-center ">
        <div className=" flex flex-col lg:text-justify space-y-4 items-center">
          <div className="header-fonts  flex items-center text-[30px] font-bold lg:text-[40px]">
          ...
          <div className="lg:text-[18px] flex justify-center items-center  flex-col lg:flex-col  mx-[40px]  space-y-2  text-[17px]">
          ...
          <div className="lg:text-[18px] lg:max-w-[445px]  mx-[40px] text-[17px]">
      ...
      <div className="bg-[#0d111a] text-white flex-col h-[400px] flex text-center space-y-2 items-center justify-center">
        ...
        <div className=" font-railway font-bold text-[40px]"> TACKLE Exclusive Club</div>
        <div className="text-[17px] lg:text-[17px] leading-6 lg:leading-5">The TACKLE official collection 10000 animated 3D NFT is Coming soon. By holding an NFT, you will get <br></br>
