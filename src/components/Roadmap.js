    ...
    <>
      <div className="bg-[#131b2a] text-white  flex-col lg:flex-row lg:h-[500px] h-[800px]  flex items-center justify-center   lg:space-x-10 space-y-14">
        <div className="space-y-5 justify-center items-center flex flex-col">
          <div className=" header-fonts lg:text-[40px] text-[30px] font-bold font-railway">
            TACKLE DEBIT CARD
          </div>
          <div className="lg:text-[18px] lg:max-w-[700px] leading-5 lg:leading-6 max-w-[330px]  text-[16px]">
          ...
          <div className="space-y-5 pr-16 flex   flex-col ">
            <div className="items-center flex flex-row space-x-3 ">
              ...
              <div className="flex flex-col">
                <div className="flex lg:flex-col flex-col lg:max-w-[600px]  lg:text-[17px]  ">
                  <div className="flex lg:flex-row flex-col lg:space-x-1 max-w-[1000px]">
                  <div className="text-[16px] lg:text-[17px] lg:max-w-[490px] max-w-[200px]">Use for online purchases or in-store shopping at </div>
                  
                  <div className="font-bold lg:text-[18px] text-[16px]">
                    37 million merchant
                  </div>
                  </div>
                  <div className="text-[16px] lg:text-[17px]">
                  locations worldwide.
                </div>
                  </div>
              </div>
            ...
            <div className="items-center flex flex-row space-x-3  ">
              ...
              <div className="text-[16px] max-w-[200px] lg:max-w-[500px] lg:text-[17px]">
            ...
            <div className="items-center flex flex-row  space-x-3 ">
              ...
              <div className="lg:text-[17px] text-[16px]">
