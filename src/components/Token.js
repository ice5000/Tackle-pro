    ...
    <>
      <div className="lg:h-[650px] h-[1450px] bg-[#0d111a]  flex justify-center items-center space-y-5 flex-col text-white ">
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-10 space-y-5 ">
          <div className="sha lg:h-[400px] lg:w-[400px] lg:text-[17px] text-[12px] border-2 w-[345px] h-[300px] border-blue-500 mt-5 space-y-5 ">
          ...
          <div className="sha lg:h-[400px] lg:w-[420px] lg:text-[17px] text-[12px]   w-[345px] h-[300px]  border-blue-500 border-2 space-y-6">
          ...
          <div className="sha lg:w-[400px] lg:h-[400px]  lg:text-[17px] text-[12px]  w-[345px] h-[300px] border-blue-500 border-2 space-y-6">
          ...
          <div className="sha lg:text-[17px] text-[12px] w-[345px] h-[300px] lg:h-[400px] lg:w-[400px] border-blue-500 border-2 space-y-6 ">
